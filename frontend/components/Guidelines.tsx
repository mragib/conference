      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full h-full flex flex-col justify-center">
        ...
        <div className="mt-8 lg:mt-12 flex flex-col md:flex-row items-center justify-between gap-6 border-t border-slate-100 pt-6 lg:pt-8">
          ...
          <div className="flex gap-3 w-full md:w-auto">
            ...
            {/* UPDATED: Link used instead of manual onClick state */}
            <Link
              href="/signUp"
              scroll={false}
              className="flex-1 md:flex-none px-6 py-3 lg:px-8 lg:py-3.5 bg-[#003366] text-white rounded-xl font-black text-[9px] lg:text-[10px] uppercase tracking-widest hover:bg-[#C5A059] transition-all shadow-lg active:scale-95 text-center flex items-center justify-center"
            >
              Submit Now
            </Link>
          </div>
