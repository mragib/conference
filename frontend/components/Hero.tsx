      ...
      <div className="relative z-10 w-full pt-24 pb-10 px-6">
        <div className="max-w-6xl mx-auto text-center text-white flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto px-4">
            <button className="group flex items-center justify-center gap-2 border border-white/30 bg-white/5 backdrop-blur-md px-8 py-4 rounded-xl font-bold uppercase text-[0.6875rem] tracking-widest hover:bg-white hover:text-[#003366] transition-all duration-300 active:scale-95">
              <FileText
                size={16}
            ...
            <button className="flex items-center justify-center gap-2 bg-[#C5A059] text-[#003366] px-10 py-4 rounded-xl font-black uppercase text-[0.6875rem] tracking-widest shadow-2xl hover:bg-white transition-all duration-300 active:scale-95">
              {"Register Now"}
