          ...
          <div className="lg:col-span-7 space-y-8">
            <header className="space-y-3 text-left">
              <h2 className="text-[#C5A059] text-[10px] md:text-xs font-black uppercase tracking-[0.4em]">
                Welcome to <span className="font-bold">International</span>{" "}
                Conference on Building Resilient Supply Chains 2026
              </h2>
            ...
            <p className="text-slate-500 text-sm md:text-base lg:text-lg leading-relaxed font-medium max-w-2xl border-l-4 border-[#C5A059]/30 pl-6 italic text-left">
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 sm:p-6 lg:p-10">
      ...
      <div className="relative bg-white w-full max-w-4xl max-h-[85vh] rounded-[2.5rem] shadow-2xl flex flex-col overflow-hidden border border-white/20 animate-in fade-in zoom-in duration-500">
        ...
        <div className="flex-grow overflow-y-auto p-6 md:p-10 custom-scrollbar overscroll-contain text-left">
          {children}
        </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-4 border-t border-slate-100">
      {themes.map((theme, i) => (
        ...
        >
          ...
          <span className="text-[#003366] text-[10px] md:text-xs font-bold leading-tight uppercase text-left">
            {theme}
          </span>
        </div>
      ))}
