...
const PaymentForm = () => {
  ...
  return (
    <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 bg-white rounded-[3rem] shadow-2xl overflow-hidden border border-slate-200 mt-4 ">
      {/* Order Summary */}
      ...
      ${
        ...
        <div className="mt-20 p-6 bg-white/5 rounded-2xl border border-white/10 flex items-center gap-4">
          ...
          <p className="text-[9px] font-medium leading-relaxed uppercase tracking-widest opacity-60">
            Secured by SSL Commerz 256-bit encryption protocol. Your transaction
            is safe.
          </p>
        </div>
      </div>
